...
// Commit
await $`git add packages/plexus-pi/package.json packages/plexus-opencode/package.json packages/plexus-oh-my-pi/package.json packages/plexus-models/package.json package.json`;
